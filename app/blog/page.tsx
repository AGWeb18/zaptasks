...
const posts = [
  {
    ...
    title: "Top 5 winter tasks to knock out before the first snowfall",
    excerpt:
  ...
  {
    slug: "canadian-cleaning-providers",
    title: "How Canadian homeowners are booking deep cleans in under 30 seconds",
    excerpt:
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50/50 to-white flex flex-col text-slate-800">
      ...
      <main className="container mx-auto px-4 py-12 flex-1">
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mt-4">Neighbourly guides for Canadian homeowners</h1>
        ...
        <div className="max-w-3xl mx-auto mt-12 text-center bg-blue-50 border border-blue-100 rounded-3xl p-8">
          ...
          <p className="text-sm text-blue-900/80 mt-2">
            Join the ZapTasks newsletter for seasonal checklists, provider spotlights, and launch offers. We share what&apos;s happening across Canadian service communities.
          </p>
        </div>
      </main>
      <SiteFooter />
